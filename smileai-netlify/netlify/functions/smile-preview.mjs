...
const PROMPTS = {
  ...
  hollywood: 'Create the ULTIMATE HOLLYWOOD CELEBRITY SMILE with PERFECT PORCELAIN VENEERS. ABSOLUTE REQUIREMENTS: 1) ZERO GAPS - every single tooth MUST touch its neighbor with absolutely NO spaces or gaps between any teeth whatsoever. 2) ULTRA BRILLIANT WHITE with GLOSSY SHINE - teeth must be the brightest, most luminous white possible with a beautiful glossy, polished sheen like they are reflecting light. 3) PERFECTLY STRAIGHT alignment - every tooth in perfect position like expensive orthodontic work. 4) UNIFORM PERFECT SHAPE - all teeth perfectly sized and shaped symmetrically. 5) COMPLETELY FILL any missing teeth. 6) Healthy pink gums. The result MUST look like a $100,000 Hollywood smile with ultra-white, SHINY, GLOSSY porcelain veneers - absolutely FLAWLESS, GLEAMING teeth with ZERO gaps. Add subtle light reflections to show the glossy shine. Do NOT change skin, hair, eyes, face, or background.',
  bright: 'Create the ULTIMATE HOLLYWOOD CELEBRITY SMILE with PERFECT PORCELAIN VENEERS. ABSOLUTE REQUIREMENTS: 1) ZERO GAPS - every single tooth MUST touch its neighbor with absolutely NO spaces or gaps between any teeth whatsoever. 2) ULTRA BRILLIANT WHITE with GLOSSY SHINE - teeth must be the brightest, most luminous white possible with a beautiful glossy, polished sheen like they are reflecting light. 3) PERFECTLY STRAIGHT alignment - every tooth in perfect position like expensive orthodontic work. 4) UNIFORM PERFECT SHAPE - all teeth perfectly sized and shaped symmetrically. 5) COMPLETELY FILL any missing teeth. 6) Healthy pink gums. The result MUST look like a $100,000 Hollywood smile with ultra-white, SHINY, GLOSSY porcelain veneers - absolutely FLAWLESS, GLEAMING teeth with ZERO gaps. Add subtle light reflections to show the glossy shine. Do NOT change skin, hair, eyes, face, or background.',
};
