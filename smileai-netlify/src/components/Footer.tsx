        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                {socialItems.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 bg-slate-800 hover:bg-blue-600"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Dental Implants</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Veneers</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Teeth Whitening</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Smile Makeover</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Invisalign</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Before & After</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Patient Reviews</a></li>
            ...
            <ul className="space-y-3 text-sm">
              {contactInfo.address && (
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-400" style={{ whiteSpace: 'pre-line' }}>{contactInfo.address}</span>
                </li>
              )}
              {contactInfo.phone && (
                <li className="flex items-start gap-3">
                  <Phone className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                  <a href={`tel:${contactInfo.phone.replace(/\D/g, '')}`} className="text-gray-400 hover:text-blue-400 transition-colors">{contactInfo.phone}</a>
                </li>
              )}
              {contactInfo.email && (
                <li className="flex items-start gap-3">
                  <Mail className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                  <a href={`mailto:${contactInfo.email}`} className="text-gray-400 hover:text-blue-400 transition-colors break-all">{contactInfo.email}</a>
                </li>
              )}
              {!contactInfo.address && !contactInfo.phone && !contactInfo.email && (
                <li className="text-gray-500 text-xs italic">Contact information can be set in Settings</li>
              )}
            </ul>
          </div>
        </div>
