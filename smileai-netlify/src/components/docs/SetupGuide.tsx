    ...
    <div style={{
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <Card>
          ...
          <Step number={1} title="Get Your CRM Credentials">
        ...
        <Card>
          ...
          <ol style={{ paddingLeft: '20px' }}>
            ...
            <li style={{ marginBottom: '10px' }}><strong>Data Synced:</strong> All images & videos saved to your CRM contact</li>
        ...
        <Card>
          ...
          <h3>Contacts not being created in your CRM?</h3>
