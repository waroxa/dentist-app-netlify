      ...
      <div style={{
        ...
        <Section title="2. Description of Service">
          ...
          <ul>
            ...
            <li>Integrates with the CRM for contact management</li>
          </ul>
        ...
        <Section title="14. CRM Integration">
          <p>
            If you use this Service through a CRM installation:
          </p>
          <ul>
            ...
            <li>the CRM provider terms of service also apply</li>
